...
export function packageExportsResolve(fs, packageURL, subpath, exports, conditions) {
    ...
    const hasDotKeys = exportsKeys === null || exportsKeys === void 0 ? void 0 : exportsKeys.some((key) => key.startsWith("."));
    const hasNonDotKeys = exportsKeys === null || exportsKeys === void 0 ? void 0 : exportsKeys.some((key) => !key.startsWith("."));
    ...
    if (exportsIsObject && hasDotKeys && !hasNonDotKeys) {
        ...
        const resolved = packageImportsExportsResolve(fs, subpath, exports, packageURL, false, conditions);
...
export function packageImportsResolve(fs, specifier, parentURL, conditions) {
    ...
    if (packageURL !== null) {
        ...
        if (typeof pjson.imports === "object" && (pjson === null || pjson === void 0 ? void 0 : pjson.imports) !== null) {
...
//# sourceMappingURL=esmResolve.js.map